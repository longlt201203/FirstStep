            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p><a class="btn hvr-hover" href="/FirstStep/shop.php">Shop New</a></p>
                    </div>
                </div>
            </div>
        </li>
...
<div class="categories-shop">
    <div class="container">
        ...
        foreach ($categories as $category) {
            ...
            $content .= '<div class="shop-cat-box" style="height: 90%;">';
            $content .= '<img class="img-fluid" src="'.$category["image"].'" alt="'.$category["name"].'">';
            $content .= '<a class="btn hvr-hover" href="/FirstStep/shop.php?category='.$category["id"].'">'.$category["name"].'</a>';
            $content .= '</div>';
            $content .= '</div>';
            $i++;
            if ($i % 3 == 0 || $i == sizeof($categories)) {
